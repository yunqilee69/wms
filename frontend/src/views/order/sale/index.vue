<template>
  <div class="app-container">
    <el-row :gutter="20">
      ...
      <el-col :span="24" :xs="24">
        <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
          ...
          <el-form-item label="客户名称" label-width="100" prop="brand">
            <el-input
          ...
          <el-form-item label="客户电话" label-width="100" prop="category">
            <el-input
        ...
        <el-row :gutter="10" class="mb8">
          ...
          <el-col :span="1.5">
            <el-button
                ...
                v-hasPermi="['order:sale:takeDelivery']"
            >送货</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button
                ...
                v-hasPermi="['order:sale:settlement']"
            >结算</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button
        ...
        <el-table v-loading="loading" :data="orderList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="单据号" align="center" key="documentCode" prop="documentCode">
            <template #default="scope">
              <router-link :to="'/order/sale-detail/' + scope.row.id" class="link-type" >
          ...
          <el-table-column label="客户电话" align="center" key="customerPhone" prop="customerPhone" :show-overflow-tooltip="true" />
          <el-table-column label="客户地址" align="center" key="customerAddress" prop="customerAddress" :show-overflow-tooltip="true" />
          ...
          <el-table-column label="状态" align="center" key="status" prop="status">
            <template #default="scope">
              <dict-tag :options="sale_order_status" :value="scope.row.status" />
            </template>
          </el-table-column>
          ...
          <el-table-column label="操作" align="center" width="150" class-name="small-padding fixed-width">
            <template #default="scope">
              <el-tooltip content="查看支付记录" placement="top" v-if="scope.row.status == '3'">
                <el-button link type="primary" icon="Edit" @click="showPictures(scope.row)" v-hasPermi="['order:sale:showPay']"></el-button>
              </el-tooltip>
            </template>
          </el-table-column>
        </el-table>
    ...
    <select-customer ref="selectRef" @ok="handleQuery"/>
...
<script setup>
import {delOrder, getOrderList, settlement, takeDelivery, getPictures} from "@/api/order/sale.js"
import DictTag from "@/components/DictTag/index.vue";
import SelectCustomer from "@/views/order/sale/selectCustomer.vue";
...
const {
  sale_order_status } =
    proxy.useDict( "sale_order_status");
...
function handleTakeDelivery() {
  ...
  proxy.$modal.confirm('是否确认送货,送货后不可修改').then(function () {
    return takeDelivery(id);
  }).then(() => {
    getList();
    proxy.$modal.msgSuccess("送货成功");
  }).catch(() => {});
}
