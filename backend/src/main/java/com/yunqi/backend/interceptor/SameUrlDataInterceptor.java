package com.yunqi.backend.interceptor;

import com.alibaba.fastjson2.JSON;
import com.yunqi.backend.annotation.RepeatSubmit;
...
//        }
        ...
        try {
            ...
            throw new BizException(SystemError.SYSTEM_ERROR);
        }
        nowParams = stringBuilder.toString();
